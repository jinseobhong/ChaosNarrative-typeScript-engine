...
[출력 JSON 포맷]
{
  ...
  "appearance": {
    "hair": { "color": "헤어 컬러", "style": "헤어 스타일", "ornament": "장신구 (선택)" },
    "eyes": { "color": "눈동자 색상", "gazeStyle": "시선 각도/형태", "expression": "기본 표정" },
    "body": { "height": "신장 느낌", "build": "체형 특징", "skinTone": "피부톤", "specialFeatures": "특수 부속기관" },
    "outfit": { "baseClothing": "기본 복장", "tensionPoints": ["장력 포인트 1", "장력 포인트 2"], "jewelryOrChoker": "장신구/초커 설명" },
    "sensory": { "temperature": "체온 묘사", "aroma": "체향" },
    "aiImagePrompt": "1girl, solo, masterwork quality prompt..."
  },
  "stats": {
    "domRate": 95.0,
    "erosRate": 5.0,
