...
import { Play, Edit3, FileJson, Copy, Trash2, Check, Sparkles, Crown, Flame } from 'lucide-react';
    ...
    <div className="bg-[#0b0e1b] border-t-2 border-purple-500/40 p-5 shadow-2xl rounded-t-2xl">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-white/10">
        ...
        <div className="flex items-center gap-3">
          <div
            className={`w-12 h-12 rounded-lg ${character.avatarColor} flex items-center justify-center font-serif text-2xl font-black text-white shadow-md`}
          >
