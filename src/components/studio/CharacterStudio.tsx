      ...
      <header className="sticky top-0 z-30 bg-[#0c0e1a]/95 backdrop-blur-md border-b border-white/10 px-6 py-3.5">
        <div className="max-w-[1700px] mx-auto flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center flex-wrap gap-2 text-xs">
            {/* 1. 캐릭터 생성 (Dynamic AI Creator Modal) */}
            <button
              onClick={() => setIsDynamicCreatorOpen(true)}
              className="flex items-center gap-1.5 px-3.5 py-1.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold rounded-lg shadow-md shadow-purple-600/30 transition-all transform hover:-translate-y-0.5 cursor-pointer"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-lg border border-white/10 font-bold transition-colors cursor-pointer"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-purple-950/60 hover:bg-purple-900/80 text-purple-200 rounded-lg border border-purple-500/40 font-bold transition-colors cursor-pointer"
            >
